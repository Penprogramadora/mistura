...
{ Webcam.snap(function(data_uri) { document.getElementById("result").innerHTML =
 ...
 classifier = ml5.imageClassifier ("https://teachablemachine.withgoogle.com/models/fgbKoP7B0/");
 function modelLoaded() { console.log('Model Loaded!'); } function check() { img = document.getElementById('selfie_image');
